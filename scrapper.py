...
def construct_url(search_term, state_name):
    # Normalize the state name to title case for case-insensitive matching
...
def fetch_contact_info(search_term, state_name):
    ...
    # Initialize undetected ChromeDriver with custom headers
    ...
    # Data list to store all the business details as dictionaries
    data = []
